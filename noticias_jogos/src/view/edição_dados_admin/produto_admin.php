...
<body>
        ...
        <div class="card card-tb" style="width: 500px; height:850px;">
            ...
            <form action="configuracao_produto.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nome_produto" class="form-control" value="<?php echo $nome_produto;?>" placeholder="Nome" required>   
                ...
                <div class="form-group">
                    <p>Preço:</p>
                    <input type="text" name="preco_produto" class="form-control" value="<?php echo $preco_produto;?>" placeholder="Preço" required>
                    <div class="valid-feedback">Correto.</div>
                    <div class="invalid-feedback">Preencha esse campo.</div>
                </div>
                ...
                <div class="form-group">
                    <p>Estoque:</p>
                    <input type="text" name="estoque_produto" class="form-control" value="<?php echo $estoque_produto;?>" placeholder="Estoque" required>
                    <div class="valid-feedback">Correto.</div>
                    <div class="invalid-feedback">Preencha esse campo.</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="text-center" type="file" name="imagem_produto"  id="update" class="form-control" value="<?php echo $imagem_produto;?>" >

                    
                    <div class="text-center anima">
                        <br><?php echo '<img src="upload/'.$imagem_produto.'" widht ="100px;" height="100px" alt="Imagem">';?>
                    </div>
    ...
    <div class="container">
        ...
        <?php $result = $conn->query("SELECT * FROM tabela_produtos") or die($mysqli->error);?>
        ...
        <!--Codigo que puxa as colunas do banco, colocandos na tabela-->
            ...
            <tr>
               ...
               <!-- <td><?php echo $row['imagem_produto'];?></td> -->
                <td><?php echo '<img src="upload/'.$row['imagem_produto'].'" widht ="100px;" height="100px" alt="Imagem">';?></td>

                <!--Botões que ficaram ao lado de cada dados (que puxará a ação dos mesmos em seus respectivos ID) para a editar e excluir-->
                <td><a href="produto_admin.php?edit=<?php echo $row['id'];?>" class="btn btn-info">Edit</a></td>
                <td><a href="configuracao_produto.php?delete=<?php echo $row['id'];?>" class="btn btn-danger">Delete</a></td>
            </tr>
            <?php endwhile;?>
            </table>
