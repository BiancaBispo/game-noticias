    ...
    <div class="container text-center text-md-left mt-5">
        <div class="row">
            ...
            <div class="col-md-3 mx-auto mb-4">
                ...
                <p class="mt-2">Somos um grupo de jovens que está realizando um projeto que busque reunir informações sobre o mundo game para facilitar o encontro das tendências do momento. </p>
            </div>
