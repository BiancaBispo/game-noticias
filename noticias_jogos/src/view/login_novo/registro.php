  ...
  $csenha = md5($_POST['csenha']);
    ...
    if($senha == $csenha) {
        ...
        if(!$result-> num_rows > 0) {
            $sql = "INSERT INTO usuarios (email,usuario,senha,nome) VALUES ('$email', '$usuario', '$senha','$nome')";
            $result = mysqli_query($conn, $sql);
            if(!$result){
      ...
      <div class="col-md-6 mx-auto ">
        <div class="card">
          <form action="" method="POST" class="box">
              ...
              <input type="text" class="form-control item" placeholder="Nome" name="nome" value="<?php echo $nome;?>" required>
