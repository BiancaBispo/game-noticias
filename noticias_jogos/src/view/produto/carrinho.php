    ...
    <div class="row no-gutters">
                ...
                <h6 class="mb-2">Carrinho</h6>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2 mt-3 p-2 items rounded">
                        <div class="d-flex flex-row align-items-center">
                            <?php echo '<img src="/noticias_jogos/src/view/edição_dados_admin/upload/'.$rows_id['imagem_produto'].'" width ="100px;" alt="Imagem">';?>                         
                            <div class="ml-2"><span class="font-weight-bold d-block"><?php echo $rows_id['nome_produto']; ?></span></div>
                        </div>
                        <div class="d-flex flex-row align-items-center"><span class="d-block">1</span><span class="d-block ml-5 font-weight-bold">
                            <?php echo'R$' .number_format($rows_id['preco_produto'],2,',','.').  '<br/>';?></span><i class="fa fa-trash-o ml-3 text-black-50"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-4" style="background: rgb(0, 0, 0);">
            <div class="payment-info">
                ...
                <hr class="line">
                <div class="d-flex justify-content-between information"><span>Total</span><span><?php echo'R$' .number_format($rows_id['preco_produto'],2,',','.').  '<br/>';?></div>
