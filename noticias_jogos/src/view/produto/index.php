...
$result_produtos = sprintf("SELECT * FROM tabela_produtos ORDER BY RAND(%d)", time()%(24*60*60));
                ...
                <div class="card mb-0">
                    <div class="project m-0">
                        <figure class="portfolio-item">
                            ...
                            <?php echo '<img class="img-responsive mx-auto d-block" src="../edição_dados_admin/upload/'.$rows_produto['imagem_produto'].'" style="width: 210px; height: 210px;" alt="Imagem">';?>
                    ...
                    <div class="card-body" style="height: 180px;" >
                        <a style="text-decoration: none;" class="card-title title-link fs-20 fw-bold text-uppercase"  href="../produto/vitrine.php?id=<?php echo $rows_produto['id'];?>"><?php echo $rows_produto['nome_produto']; ?></a>
